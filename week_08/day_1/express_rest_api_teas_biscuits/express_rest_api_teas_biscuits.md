...
1. When the form is submitted, `FormView` creates an object using the submitted values with the key `consumable`. It publishes this object on the channel `FormView:submit-teas`.

...
public class BedroomTest {
    ...
    @Before
    public void before() {
        singleRoom = new Bedroom(101, BedRoomType.SINGLE, 1, 25.00);
        doubleRoom = new Bedroom(102, BedRoomType.DOUBLE, 2, 50.00);
    ...
    public void singleRoomHasRoomType() {
        assertEquals(BedRoomType.SINGLE, singleRoom.getType());
    }
    ...
    public void doubleRoomHasRoomType() {
        assertEquals(BedRoomType.DOUBLE, doubleRoom.getType());
    }
